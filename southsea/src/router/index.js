  ...
  routes: [
    {
      ...
      children:[
        ...
        { 
          ...
          children:[
            {path:"ProductionBase",name:"ProductionBase",component:ProductionBase,meta: { title: '生产主体库' },},
            {path:"ProductionInformationBase",name:"ProductionInformationBase",component:ProductionInformationBase,meta: { title: '鱼塘生产信息库' }}
          ],
        },
        { 
