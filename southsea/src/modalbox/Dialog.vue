    ...
    >
        ...
        <el-col :span="18">
          ...
          >
            ...
            <el-form-item class="elfitem">
              ...
              <el-input autocomplete="off" class="elfitem-input"></el-input>
            </el-form-item>
            <el-form-item class="elfitem">
              <label class="elfitem-label">大棚</label>
              <el-checkbox-group v-model="formInline.type" style="width: 233px">
            ...
            <el-form-item class="elfitem">
              ...
              <el-input
                ...
                :disabled="true"
              >
                <el-button slot="append" @click="lotn">定位</el-button>
              </el-input>
            </el-form-item>
          </el-form>
        </el-col>
      ...
      <el-card class="elcard">
        <div slot="header" class="clearfix">
          ...
          >
            ...
            <el-card shadow="always" :body-style="{ padding: '20px' }">
              <el-input style="width: 380px;margin-right: 10px;" type="text" placeholder="请输入主体名称（模糊搜索）"></el-input>
        ...
        <el-table border style="width: 100%">
          <el-table-column fixed prop="date" label="主体名称" width="200">
          </el-table-column>
          <el-table-column prop="name" label="基础/土名" width="200">
          </el-table-column>
          <el-table-column prop="province" label="占地面积（亩）" width="120">
          </el-table-column>
          <el-table-column prop="city" label="年产值（万元）" width="120">
          </el-table-column>
          <el-table-column prop="address" label="承包开始时间" width="120">
          </el-table-column>
          <el-table-column prop="zip" label="承包结束时间" width="120">
          </el-table-column>
          ...
          <el-col>
            <div class="elcol-header">
              ...
              >
                ...
                <span slot="footer" class="dialog-footer">
                  <el-button type="primary" @click="shVisible = false"
                    >确 定</el-button
                  >
                </span>
              </el-dialog>
